...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center p-10 gap-6">
      <h1 className="text-4xl font-bold text-yellow-500">LuxuryHook ✨</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-6xl">
        ...
        <div className="bg-zinc-800 p-6 rounded-xl">
          ...
          {content && <div className="mb-4"><p>{content}</p></div>}

          {(title || description) && (
            <div className="p-4 rounded border-l-4" style={{ borderColor: color }}>
